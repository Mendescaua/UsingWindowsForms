...
{
    public partial class ValidaSenha : Form
    {
        public ValidaSenha()
        {
            InitializeComponent();
        ...
        private void Lbl_Resultado_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            //Esta verificando se oq vc digitou(senha) é forte, fraco.....
            ChecaForcaSenha checar = new ChecaForcaSenha();
            ChecaForcaSenha.ForcaDaSenha forca;
            forca = checar.GetForcaDaSenha(Txt_Senha.Text);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Txt_Senha.UseSystemPasswordChar = !Txt_Senha.UseSystemPasswordChar;

            // Altera o texto do botão para indicar o estado
